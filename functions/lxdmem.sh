...
# lxdmem.sh
#
# Related task: ENG-2205
# Forked from: https://github.com/coleplx/workscripts/blob/master/lxdmem.sh
#
...
RUNNING_CONTAINERS=$(ls -ld /sys/fs/cgroup/memory/lxc.payload* | rev | cut -d'.' -f1 | rev)
...
echo ""
echo "------ System Info ------"
echo "Running containers: $SUM_RUNNING_CONTAINERS/$TOTAL_CONTAINERS"
